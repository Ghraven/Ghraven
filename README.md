...
<p align="left">
  <img src="https://img.shields.io/badge/PRs_opened-127-blue?style=flat-square" alt="PRs opened" />
  ...
  <img src="https://img.shields.io/badge/Contributed_to_repos_with-900k%2B_⭐-yellow?style=flat-square" alt="Combined stars of contributed repos" />
</p>
...
| [ccxt/ccxt](https://github.com/ccxt/ccxt) ⭐42k | Fixed `watch_orders` message hash bug in GRVT exchange · Replaced deprecated `datetime.utcnow()` in Python examples with timezone-aware UTC · Switched a pro close async test to the active running loop |
