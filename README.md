...
<p align="left">
  <img src="https://img.shields.io/badge/PRs_opened-137-blue?style=flat-square" alt="PRs opened" />
  ...
  <img src="https://img.shields.io/badge/Contributed_to_repos_with-914k%2B_⭐-yellow?style=flat-square" alt="Combined stars of contributed repos" />
</p>
...
| [reconurge/flowsint](https://github.com/reconurge/flowsint) ⭐3.5k | Replaced naive `datetime.utcnow()` service timestamps with timezone-aware UTC values in analysis, chat, and flow services, plus focused timestamp regression tests · Read Sherlock and Maigret social-enricher output files with explicit UTF-8 encoding |
